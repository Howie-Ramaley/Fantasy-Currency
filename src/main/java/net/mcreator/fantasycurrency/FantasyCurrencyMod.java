 ...
 *
 */
package net.mcreator.fantasycurrency;
...
@Mod("fantasy_currency")
public class FantasyCurrencyMod {
	public static final Logger LOGGER = LogManager.getLogger(FantasyCurrencyMod.class);
	public static final String MODID = "fantasy_currency";
